...
COPY src/DataBalk.Mcp.sln ./
COPY src/DataBalk.Mcp.Server.Copilot/*.csproj ./DataBalk.Mcp.Server.Copilot/
COPY src/DataBalk.Mcp.Common/*.csproj ./DataBalk.Mcp.Common/
COPY src/DataBalk.Mcp.Client/*.csproj ./DataBalk.Mcp.Client/
